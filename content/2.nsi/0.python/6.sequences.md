...
print(type(mon_liste), ":", mon_liste)
print(type(mon_liste[0]), ":", mon_liste[0])
print(type(mon_liste[1]), ":", mon_liste[1])
print(type(mon_liste[2]), ":", mon_liste[2])
print(type(mon_liste[3]), ":", mon_liste[3])
